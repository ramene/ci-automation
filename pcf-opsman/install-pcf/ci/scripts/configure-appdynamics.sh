...
json_file_path="pcf-automation/pcf-opsman/install-pcf/product_configs/appdynamics"
json_file_template="${json_file_path}/${APPDYNAMICS_TEMPLATE}"
json_file="${json_file_path}/appdynamics.json"
